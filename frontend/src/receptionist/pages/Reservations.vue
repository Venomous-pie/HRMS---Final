<template>
  <div class="p-6">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
      <div class="mb-4">
        <h2 class="text-lg font-semibold text-gray-800">Reservations Table</h2>
      </div>
          ...
          <tbody>
            <tr v-for="reservation in reservations" :key="reservation.bookingNumber || reservation.id">
              ...
              <td class="py-2 px-4 text-xs text-gray-700">
                <button class="px-2 py-1 text-xs text-green-600 border border-green-200 rounded hover:bg-green-50" @click="handleOrder(reservation)">Orders</button>
              </td>
